...
- 👥 **Multiple server/users**: Seemlessly switch between multiple servers.
- 🖥️ **Local connection handling**: use internal network adddress / public address based on current network.
